      ...
      <div className="relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {projects.map((project, i) => (
            <div
              key={i}
              className="bg-zinc-100 dark:bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-200 dark:border-zinc-800 hover:border-blue-500/40 transition duration-300"
            >
              {/* IMAGE */}
